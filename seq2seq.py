...
tf.app.flags.DEFINE_integer('save_freq', 60, 'Save model checkpoint every this iteration')
tf.app.flags.DEFINE_integer('valid_freq', 60, 'Evaluate model every this iteration: valid_data needed')
